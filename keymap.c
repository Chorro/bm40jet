...
[_QWERTY] = LAYOUT_planck_mit(
    ...
    XXXXXXX, XXXXXXX, XXXXXXX, KC_LGUI,     MO2,      KC_SPC     , LT3_ENT, KC_RGUI, XXXXXXX, XXXXXXX, XXXXXXX
),


[_ARROWS] = LAYOUT_planck_mit(
    XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,   KC_UP, XXXXXXX, XXXXXXX, KC_TRNS,
    XXXXXXX, KC_LSFT, KC_LCTL, KC_LALT, KC_RGUI, XXXXXXX, XXXXXXX, KC_LEFT, KC_DOWN, KC_RGHT, XXXXXXX, XXXXXXX,
    XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_VOLD, KC_VOLU, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
    XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_TRNS,     KC_TRNS     , ADJ_ENT, XXXXXXX, XXXXXXX, XXXXXXX, KC_MUTE
),
...
[_SYMBOLS] = LAYOUT_planck_mit(
    ...
    XXXXXXX, XXXXXXX, XXXXXXX, KC_TRNS,     MO5,     KC_TRNS     , XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX
),
...
[_NUMPAD] = LAYOUT_planck_mit(
    ...
    XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,     KC_TRNS     ,   KC_P0, KC_PDOT, XXXXXXX, XXXXXXX, XXXXXXX
),

[_ADJUST] = LAYOUT_planck_mit(
      KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,  KC_F10,  KC_F11,  KC_F12,
    RGB_MOD, RGB_HUI, RGB_SAI, RGB_VAI, RGB_SPI, XXXXXXX, XXXXXXX, KC_MRWD, KC_MPLY, KC_MFFD, XXXXXXX,   SLEEP,
   RGB_RMOD, RGB_HUD, RGB_SAD, RGB_VAD, RGB_SPD, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
    RGB_TOG, XXXXXXX, XXXXXXX, XXXXXXX, KC_TRNS,     KC_TRNS     , KC_TRNS, XXXXXXX, XXXXXXX, XXXXXXX,  QK_BOOT
)
